...
-- Migration: Add free-form positioning columns if table already exists:
-- ALTER TABLE notes ADD COLUMN IF NOT EXISTS pos_x REAL NOT NULL DEFAULT 0;
-- ALTER TABLE notes ADD COLUMN IF NOT EXISTS pos_y REAL NOT NULL DEFAULT 0;
-- ALTER TABLE notes ADD COLUMN IF NOT EXISTS width REAL NOT NULL DEFAULT 200;
-- ALTER TABLE notes ADD COLUMN IF NOT EXISTS height REAL NOT NULL DEFAULT 120;
